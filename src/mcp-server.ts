...
- **create-channel**: Use to create a channel in a workspace. Pass workspaceId, name, and optional description, public, or userIds. Call get-users first when resolving people; pass user IDs, not emails or names.
